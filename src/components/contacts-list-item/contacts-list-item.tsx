  ...
  return (
    <div className={styles.item_cont} onClick={onClick}>
      ...
      <div className={styles.user_data}>
        <label className={styles.user_data__label}>Имя</label>
        <p className={styles.user_data__value}>{contact.name}</p>
        <label className={styles.user_data__label}>Телефон</label>
        <p className={styles.user_data__value}>{contact.phone}</p>
        <label className={styles.user_data__label}>Email</label>
        <p className={styles.user_data__value}>{contact.email}</p>
        <label className={styles.user_data__label}>День рождения</label>
        <p className={styles.user_data__value}>
          {convertDate(contact.birthday)}
        </p>
        <label className={styles.user_data__label}>Адрес</label>
